...
def gain_perturbation(var, outdir, mapdir, nlat, nlon, eTot,
    ...
    widthclass = pd.read_csv("/project/uma_colin_gleason/yuta/SIRF/data/MCZ/priorinfo/WidthsClass.csv", index_col=0)
    ...
    if var == "rivman":
        nclass = pd.read_csv("/project/uma_colin_gleason/yuta/SIRF/data/MCZ/priorinfo/priorsNClass.csv", index_col=0)
        ...
        sclass = pd.read_csv("/project/uma_colin_gleason/yuta/SIRF/data/MCZ/priorinfo/priorsRClass.csv", index_col=0)
    ...
    for e in range(eTot):
        ...
        if var == "rivshp":
            ...
            subprocess.check_call(["/project/uma_colin_gleason/yuta/SIRF/dasrc/MCZ/fsrc/calc_rivbta", crivshp, crivbta,
